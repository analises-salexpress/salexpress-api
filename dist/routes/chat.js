...
const chatDataService_1 = require("../services/chatDataService");
...
async function executeTool(name, input) {
    switch (name) {
        case 'get_overview': return (0, chatDataService_1.toolGetOverview)(input);
        case 'get_top_clients': return (0, chatDataService_1.toolGetTopClients)(input);
        case 'get_client_detail': return (0, chatDataService_1.toolGetClientDetail)(input);
        case 'get_churn_risk': return (0, chatDataService_1.toolGetChurnRisk)(input);
        case 'get_growth_clients': return (0, chatDataService_1.toolGetGrowthClients)(input);
        case 'get_route_analysis': return (0, chatDataService_1.toolGetRouteAnalysis)();
        case 'search_clients': return (0, chatDataService_1.toolSearchClients)(input);
...
router.post('/analyze', async (req, res) => {
    ...
    const messages = body.data.messages.map((m) => ({
        role: m.role,
        content: m.content,
    }));
